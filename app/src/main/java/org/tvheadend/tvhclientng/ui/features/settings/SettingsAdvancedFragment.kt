...
import org.tvheadend.tvhclientng.util.worker.LoadChannelIconWorker
    ...
    private fun mailLogfile(filename: String?) {
        ...
        try {
            context?.let {
                ...
                fileUri = FileProvider.getUriForFile(it, "org.tvheadend.tvhclientng.fileprovider", logFile)
            }
